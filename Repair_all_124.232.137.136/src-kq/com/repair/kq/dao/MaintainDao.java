...
public interface MaintainDao {
	 ...
	 * 判断是否存在本id之外相同班组
	 */
	public List<KQRule> existence(Long ruleId,String bzid);
	 ...
	 * 查询所有工时项目
	 */
	List<KQWorkTimeItem> findWorkTimeItems(Long proteamId,String itemName);
