...
<%@page import="com.repair.work.dao.impl.UsersPrivsDaoImpl"%>
<%@page import="com.repair.common.pojo.UsersPrivs"%>
<%
		...
		<td id="hideCon" class="ver01 ali01">
							<div id="lbox">
								...
								<div id="lbox_middleright">
										<div id="bs_left">
											<IFRAME scrolling="no" width="100%"  frameBorder=0 id=frmleft name=frmleft src="pj_left.jsp"  allowTransparency="true"></IFRAME>
										</div>
		...
		<td class="ali01 ver01"  width="100%">
							<div id="rbox">
								...
								<div id="rbox_middleright">
									<div id="bs_right">
										<iframe scrolling="true" width="100%" frameBorder=0 id=frmright name=frmright src="templete/open.html" onload="iframeHeight('frmright')" allowTransparency="true"></iframe>
									</div>
								</div>
								</div>
								</div>
