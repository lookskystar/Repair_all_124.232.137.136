...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <tr>
    ...
    <td height="19" width="994"><input name="B1b1" value="${itemRecs.B1b1}" recid="${itemRecs.B1b1id}" type="text" style="width:50px;"/></td>
    <td height="19" width="994"><input name="B1b2" value="${itemRecs.B1b2}" recid="${itemRecs.B1b2id}" type="text" style="width:50px;"/></td>
    <td height="19" width="994"><input name="B1b3" value="${itemRecs.B1b3}" recid="${itemRecs.B1b3id}" type="text" style="width:50px;"/></td>
    <td height="19" width="994"><input name="B1b4" value="${itemRecs.B1b4}" recid="${itemRecs.B1b4id}" type="text" style="width:50px;"/></td>
    <td height="19" width="994"><input name="B1b5" value="${itemRecs.B1b5}" recid="${itemRecs.B1b5id}" type="text" style="width:50px;"/></td>
    <td height="19" width="994"><input name="B2b1" value="${itemRecs.B2b1}" recid="${itemRecs.B2b1id}" type="text" style="width:50px;"/></td>
    <td height="19" width="994"></td>
    <td height="19" width="994"></td>
    <td height="19" width="994"></td>
    <td height="19" width="994"></td>
  ...
  <tr>
    <td width="994" rowspan="12">其 <br />
      ...
      况</td>
    <td width="1988">电器</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="B2b2" recid="${itemRecs.B2b2id}" value="${itemRecs.B2b2}"/></td>
  </tr>
  <tr>
    <td width="1988">电子</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="B2b3" recid="${itemRecs.B2b3id}" value="${itemRecs.B2b3}"/></td>
  </tr>
  <tr>
    <td width="1988">电机</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="B2b4" recid="${itemRecs.B2b4id}" value="${itemRecs.B2b4}"/></td>
  </tr>
  <tr>
    <td width="1988">制动</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="B2b5" recid="${itemRecs.B2b5id}" value="${itemRecs.B2b5}"/></td>
  </tr>
  <tr>
    <td width="1988">台车</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="B3b1" recid="${itemRecs.B3b1id}" value="${itemRecs.B3b1}"/></td>
  </tr>
  <tr>
    <td width="1988">受电弓</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="B3b2" recid="${itemRecs.B3b2id}" value="${itemRecs.B3b2}"/></td>
  </tr>
  <tr>
    <td width="1988">主断</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="B3b3" recid="${itemRecs.B3b3id}" value="${itemRecs.B3b3}"/></td>
  </tr>
  <tr>
    <td width="1988">仪表</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="B3b4" recid="${itemRecs.B3b4id}" value="${itemRecs.B3b4}"/></td>
  </tr>
  <tr>
    <td width="1988">充电</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="B3b5" recid="${itemRecs.B3b5id}" value="${itemRecs.B3b5}"/></td>
  </tr>
  <tr>
    <td width="1988">柴备</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="c1" recid="${itemRecs.c1id}" value="${itemRecs.c1}"/></td>
  </tr>
  <tr>
    <td width="1988">自停</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="c2" recid="${itemRecs.c2id}" value="${itemRecs.c2}"/></td>
  </tr>
  <tr>
    <td width="1988">其他</td>
    <td colspan="17" valign="top"><input type="text" style="width:500px;" name="f1" recid="${itemRecs.f1id}" value="${itemRecs.f1}"/></td>
  </tr>
</table>
