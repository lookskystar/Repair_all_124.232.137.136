...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  <div class="box2" panelTitle="待审批的报活列表" roller="false" showStatus="false">
  	<div>
	...
	<div id="scrollContent" >
		<table class="tableStyle"  useMultColor="true">
			...
			<c:forEach items="${pageModel.datas}" var="predict" varStatus="i">
				<tr align="center">
				<td width="25">${i.index+1}</td>
				<td width="100">${predict.pjDynamicInfo.pjName}</td>
				<td width="100">${predict.pjDynamicInfo.pjNum}</td>
				<td width="70">${predict.maker}</td>
				<td width="100">
					...
					<c:choose>
						...
						<c:otherwise>
							<c:choose>
								...
								<c:otherwise>
									<a href="javascript:;" onclick="choiceBZ(${predict.predictId})">指派班组</a>
	...
	<div style="height:35px;">
		...
		<div class="float_right padding5 paging">
			<pg:pager items="${pageModel.count}" url="partFixAction!approvePredictList.do" maxPageItems="10" export="currentPageNumber=pageNumber">
