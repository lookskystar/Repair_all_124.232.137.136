...
<body>
<form action="uploadExcel!uploadPlanExcel.do" method="post" onsubmit="return subForm();" enctype="multipart/form-data" target="frmright">
	...
	<table class="tableStyle" useHover="false" useClick="false">
	    <tr>
	      <td align="center">
	         ...
	         <a href="<%=basePath%>page/plan/plan_temp.xls" style="color: red;">excel模板下载</a>
	      </td>
	    </tr>
		<tr>
