		...
		<td id="hideCon" class="ver01 ali01">
							<div id="lbox">
								...
								<div id="lbox_middleright">
										<div id="bs_left">
											<IFRAME scrolling="no" width="100%"  frameBorder=0 id=frmleft name=frmleft src="loginAction!getUserFuncs.do?type=2"  allowTransparency="true"></IFRAME>
										</div>
		...
		<td class="ali01 ver01"  width="100%">
							<div id="rbox">
								...
								<div id="rbox_middleright">
									<div id="bs_right">
										<iframe scrolling="true" width="100%" height="500px" frameBorder=0 id=frmright name=frmright src="templete/open.html" allowTransparency="true"></iframe>
									</div>
								</div>
								</div>
								</div>
