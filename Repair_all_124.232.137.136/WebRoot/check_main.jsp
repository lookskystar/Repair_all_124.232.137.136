...
<!--头部与导航start-->
	...
	<ul id="nav">
		...
		<li class="top"><a class="top_link"><span class="down">检修记录</span></a><img src="images/9.png"/>
			<ul class="sub">
				<li><a href="<%=basePath %>report/select_main.jsp" class="fly">机车检修记录</a>
					<ul>
						<li><a href="<%=basePath%>query!query.do?lastOne=1&xcxc=Z&startTime=''&endTime=''&jcType=0&jcNum=" target="_blank"" target="jcmain">中&nbsp;&nbsp;修</a></li>
						<li><a href="<%=basePath%>query!query.do?lastOne=1&xcxc=X&startTime=''&endTime=''&jcType=0&jcNum=" target="_blank"" target="jcmain">小&nbsp;&nbsp;修</a></li>
						<li><a href="<%=basePath%>query!query.do?lastOne=1&xcxc=F&startTime=''&endTime=''&jcType=0&jcNum=" target="_blank"" target="jcmain">辅&nbsp;&nbsp;修</a></li>
						<li><a href="<%=basePath%>query!query.do?lastOne=1&xcxc=LX&startTime=''&endTime=''&jcType=0&jcNum=" target="_blank"" target="jcmain">临&nbsp;&nbsp;修</a></li>
						<li><a href="<%=basePath%>query!query.do?lastOne=1&xcxc=JG&startTime=''&endTime=''&jcType=0&jcNum=" target="_blank"" target="jcmain">加&nbsp;&nbsp;改</a></li>
						<li><a href="<%=basePath%>query!query.do?lastOne=1&xcxc=QZ&startTime=''&endTime=''&jcType=0&jcNum=" target="_blank"" target="jcmain">整&nbsp;&nbsp;治</a></li>
						<li><a href="<%=basePath%>query!query.do?lastOne=1&xcxc=CJ&startTime=''&endTime=''&jcType=0&jcNum=" target="_blank"" target="jcmain">春&nbsp;&nbsp;鉴</a></li>
						<li><a href="<%=basePath %>report/select_main.jsp" target="_blank"" target="jcmain">其&nbsp;&nbsp;他</a></li>
					</ul>
				</li>
				<li><a href="#nogo3">配件检修记录</a></li>
			</ul>
		</li>
	</ul>
<!--头部与导航end-->
		...
		<td id="hideCon" class="ver01 ali01">
							<div id="lbox">
								...
								<div id="lbox_middleright">
										<div id="bs_left">
											<iframe scrolling="no" width="100%"  frameBorder=0 id=frmleft name=frmleft src="loginAction!getUserFuncs.do?type=5"  allowTransparency="true"></iframe>
										</div>
