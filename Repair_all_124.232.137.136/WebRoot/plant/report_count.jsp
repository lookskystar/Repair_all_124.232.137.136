...
<body>
	<form action="timecount!reportCount.do" method="post" id="subForm">
		...
		<table class="tableStyle"  useMultColor="true" >
			<tr>
		      ...
		      <th width="30px" align="center"></th>
		       --%>
		      <th width="30%" align="center"><span>报活人姓名</span></th>
		      <th width="25%" align="center"><span>报活数量统计</span></th>
		      <th width="25%" align="center"><span>报活分值统计</span></th>
			   	...
			   	<c:forEach items="${jtpredict.datas}" var="jtpredict" >
			   		<tr>
			   			...
			   			<td width="25" align="center"><input id="" name="" type="checkbox" value=""/></td>
			   			 --%>
						<td align="center"><span>${jtpredict[0]}</span></td>
						<td align="center"><span>${jtpredict[1]} &nbsp;&nbsp;&nbsp;件</span></td>
						<td align="center"><span>${jtpredict[2]} &nbsp;&nbsp;&nbsp;分</span></td>
						<td align="center">
	...
	<div class="float_right padding5 paging">
		<div class="float_left padding_top4">
			<pg:pager maxPageItems="${pageSize }" url="timecount!reportCount.do" items="${jtpredict.count }" export="page1=pageNumber">
...
<script type="text/javascript">
		//查看记录
		function view(repemp){
			var diag = new top.Dialog();
			diag.Title = "记录查询窗口";
			diag.URL = "timecount!reportItem.do?repemp="+repemp;
			diag.Width=1200;
			diag.Height=520;
			diag.show();
		}
