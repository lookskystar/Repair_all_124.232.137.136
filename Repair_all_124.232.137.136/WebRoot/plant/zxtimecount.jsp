...
<body>
	<form action="timecount!getZxDuration.do" method="post" id="subForm">
	<div class="box2" panelTitle="中修工时统计" roller="false">
		<table>
			<tr>
				<td>开始时间：</td>
			...
			<tr>	
				...
				<td>工人姓名：</td>
				<td><input type="text" id="fixemp" name="fixEmp" value="${fixEmp }"/></td>
		...
		<table class="tableStyle"  useMultColor="true" >
			<tr>
		      ...
		      <th width="30px" align="center"></th>
		       --%>
		      <th width="30%" align="center"><span>工人姓名</span></th>
		      <th width="30%" align="center"><span>中修时长</span></th>
			   	...
			   	<c:forEach items="${pm.datas}" var="item" >
			   		<tr>
			   			...
			   			<td width="25" align="center"><input id="" name="" type="checkbox" value=""/></td>
			   			 --%>
						<td width="30%" align="center"><span>${fn:substring(item[0],1,fn:length(item[0])-1)}</span></td>
						<td width="30%" align="center"><span>${item[1]} &nbsp;&nbsp;&nbsp;分钟</span></td>
	...
	<div class="float_right padding5 paging">
		<div class="float_left padding_top4">
			<pg:pager maxPageItems="${pageSize}" url="timecount!getZxDuration.do" items="${dataSize}" export="page1=pageNumber">
...
<script type="text/javascript">
		...
		function view(fixEmp){
			...
			diag.Title = "记录查询窗口";
			diag.URL = "timecount!zxItemTime.do?fixEmp="+fixEmp;
			diag.Width=1200;
			diag.Height=520;
			diag.show();
		}
