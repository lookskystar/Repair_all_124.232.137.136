...
<body> 
	<form action="timecount!reportItem.do" method="post" id="subForm">
	<input type="hidden" id="repemp" name="repemp" value="${repemp }" />
	<div class="box1" roller="false">
		...
		<table class="tableStyle"  useMultColor="true">
			<tr>
		      	...
		      	<th scope="col" width="10%" align="center">报活人</th>
		      	<th scope="col" width="6%" align="center">报活分值</th>
		    ...
		    <c:if test="${!empty jtpredict}">
			   	<c:forEach items="${jtpredict.datas}" var="jtpredict" >
			   		 <tr>
			      		...
			      		<td class="row" align="center">${jtpredict.repemp}</td>
			      		<td class="row" align="center">${jtpredict.score}分</td>
	...
	<div class="float_right padding5 paging">
		<div class="float_left padding_top4">
			<pg:pager maxPageItems="${pageSize }" url="timecount!reportItem.do" items="${jtpredict.count }" export="page1=pageNumber">
				<pg:param name="startDate" value="${startDate}" /> 
				<pg:param name="endDate" value="${endDate}" /> 
				<pg:param name="jcNum" value="${jcNum}" /> 
				<pg:param name="repemp" value="${urlEmp}" />
