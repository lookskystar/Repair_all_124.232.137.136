...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
 	<form action="question!listQuestion.do" method="post" id="subfrom">
 	<div>
 		<table>
 			<tr>
 			...
 			<tr>
 				<td>关&nbsp;&nbsp;键&nbsp;&nbsp;字：<input type="text" watermark="输入关键字"  name="questions" value="${questions }"/></td>
				<td>发&nbsp;&nbsp;布&nbsp;&nbsp;人：<input type="text" watermark="输入发布人姓名"  name="uploader" value="${uploader }"/></td>
