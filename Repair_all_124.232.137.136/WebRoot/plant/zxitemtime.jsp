...
<body> 
	<form action="timecount!zxItemTime.do" method="post" id="subForm">
	...
	<div id="scrollContent">
		<table class="tableStyle"  useMultColor="true">
			<tr>
		      	...
		      	<th scope="col" width="10%" align="center">机车 编号</th>
		      	<th scope="col" width="10%" align="center">工时</th>
		    </tr>
		    <c:if test="${!empty jczxfixrec}">
			   	<c:forEach items="${jczxfixrec.datas}" var="jczxfixrec" >
			   		 <tr>
			      		<td class="row" width="10%" align="center"><c:if test="${!empty jczxfixrec.fixEmp}">${fn:substring(jczxfixrec.fixEmp, 1, fn:length(jczxfixrec.fixEmp)-1) }</c:if></td>
			      		<td class="row" width="50%" align="left">${jczxfixrec.itemName}&nbsp;</td>
			      		<td class="row" width="10%" align="center">${jczxfixrec.fixSituation}&nbsp;</td>
			      		<td class="row" width="10%" align="center">${jczxfixrec.jcType}&nbsp;</td>
			      		<td class="row" width="10%" align="center">${jczxfixrec.jcNum}&nbsp;</td>
				  		<td class="row" width="10%" align="center">${jczxfixrec.duration}&nbsp;&nbsp;分钟</td>
			    	</tr>
			   	</c:forEach>
			 </c:if>
		    <c:if test="${empty jczxfixrec.datas}">
			 	<tr> 
	...
	<!-- 处理分页 -->
	<div class="float_left padding5">  共有信息${jczxfixrec.count}条。</div>
	<div class="float_right padding5 paging">
		<div class="float_left padding_top4">
			<pg:pager maxPageItems="${pageSize }" url="timecount!zxItemTime.do" items="${jczxfixrec.count }" export="page1=pageNumber">
