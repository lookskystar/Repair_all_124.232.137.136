...
<body>
	<form action="teach!techManage.do" method="post" id="subForm">
	<div class="box2" panelTitle="临修分析" roller="false" overflow="auto">
		<table>
			<tr>	
				<td>整修类型：</td>
				<td>
					<select id="type" name="type">
						...
						<option value="LX">临修</option>
						<option value="JG">加改</option>
					</select>
				</td>
				<td>机车编号：</td>
				<td><input type="text" id="jcnum" name="jcnum"/></td>
			</tr>
			<tr>
				<td>开始时间：</td>
			   	...
			   	<c:forEach items="${DatePlanPriPm.datas}" var="datePlanPri" >
			   		<tr>
						...
						<td width="20%" align="center">
							<a onclick="view('${datePlanPri.rjhmId}');">查看记录</a>
						</td>
					</tr>
			   	</c:forEach>
			 </c:if>
	...
	<div class="float_right padding5 paging">
		<div class="float_left padding_top4">
			<pg:pager maxPageItems="${pageSize }" url="teach!techManage.do" items="${DatePlanPriPm.count }" export="page1=pageNumber">
...
<script type="text/javascript">
		//查看记录
		function view(rjhmId){
			var diag = new top.Dialog();
			diag.Title = "记录查询窗口";
			diag.URL = "teach!tempRecord.do?rjhmId="+rjhmId;
			diag.Width=1200;
			diag.Height=520;
			diag.show();
		}
