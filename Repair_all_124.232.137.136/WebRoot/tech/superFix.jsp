...
<body>
	<form action="teach!superFix.do" method="post" id="subForm">
	...
	<div class="float_right padding5 paging">
		<div class="float_left padding_top4">
			<pg:pager maxPageItems="${pageSize }" url="teach!superFix.do" items="${DatePlanPriPm.count }" export="page1=pageNumber">
...
<script type="text/javascript">
		...
		function view(rjhmId){
			...
			diag.Title = "记录查询窗口";
			diag.URL = "teach!superFix.do?rjhmId="+rjhmId;
			diag.Width=1200;
			diag.Height=520;
			diag.show();
		}
