 ...
 <div id="scrollContent">
 	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
 	  <tr>
 		...
 		<td class="ver01">
 			<div class="box2"  panelTitle="机车信息" panelHeight="465"  showStatus="false">
 				<iframe scrolling="no" width="100%" frameBorder=0 id="userIframe" name="userIframe" onload="iframeHeight('userIframe')" src="<%=basePath%>teach!runDepartDict.do?temp="+<%=System.currentTimeMillis() %>  allowTransparency="true"></iframe>
 			</div>
 		</td>
	</tr>
 </table>
