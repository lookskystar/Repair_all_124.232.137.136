...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
 	<form action="teach!runDepartDict.do" method="post">
 	<div>
	...
	<div class="float_right padding5 paging">
		<div class="float_left padding_top4">
			<pg:pager maxPageItems="${pageSize }" url="teach!runDepartDict.do" items="${jtRunKiloRecPm.count }" export="page1=pageNumber">
...
<script type="text/javascript">
		function fixView(jctype, jcnum){
			...
			diag.Title = "记录查询窗口";
			diag.URL = "teach!runFixInfoRecord.do?jcType="+jctype+"&jcnum="+jcnum+"";
			diag.Width=1200;
			diag.Height=520;
			diag.show();
		}
