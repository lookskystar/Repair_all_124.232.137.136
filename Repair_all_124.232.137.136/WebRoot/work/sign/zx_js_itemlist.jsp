...
<table class="treeTable" style="text-align: center;" initState="collapsed" id="freeItemTab">
   <tr style="background-color: lightblue;"><td colspan="11" align="left" style="font-weight: bolder;">
   <a id="aa">自选签认项目</a>&nbsp;&nbsp;<%-- <font color="red">(*自选项目不能全签)</font><button anchor="bz" id="nbz">签认项目</button>--%></td></tr>
   <tr>
		<th width="30px">选择</th>
		<c:if test="${xtype==0}">
			<th width="15%">部件/部位</th>
