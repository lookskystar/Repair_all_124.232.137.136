...
<td width="80px" align="right">存储位置：</td><td width="100px" align="left">
...
<td width="100px" align="right">配件状态：</td><td width="100px" align="left">
...
<table width="864" border="0" align="center" cellspacing="0" vspace="0">
 <tr>
	...
	<table width="864" border="0" align="center" cellspacing="0" vspace="0" id="datatabel">
		...
		<tr>
			<td class="tbCELL1" align="center" name="secondname">${detail.fixItem }</td>
			<td class="tbCELL1" align="center" name="secondname">${detail.posiName }</td>
