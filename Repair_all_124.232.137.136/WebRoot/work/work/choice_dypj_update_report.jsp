...
<body>
<form id="form" action="workAction!choiceDyPjInfo.do" method="post" onsubmit="return checkform()">
			...
			<c:if test="${!empty pm.datas}">
				<c:forEach items="${pm.datas}" var="pjd">
				   ...
				   <td class="ver01" align="center">
				    	<input type="radio" id="${pjd.pjdid}" name="pjIds" value="${pjd.pjNum}"/></td>
