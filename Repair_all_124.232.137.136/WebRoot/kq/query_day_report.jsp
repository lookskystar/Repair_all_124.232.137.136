...
<form id="form" action="rewardAction!queryDayReport.do" method="post">	
   <table>
    <tr>
      <td>班组:</td>
      <td>
...
<div id="scrollContent">
	...
	<c:forEach var="workTime" items="${workTimes}" varStatus="s">
		<tr>
			...
			<td align="center">${workTime.proteam.proteamname }</td>
			<td align="center">${workTime.gonghao }</td>
			<td align="center">${workTime.name }</td>
			<td align="center">${workTime.time }</td>
			<td align="center">${workTime.workContent }</td>
			<td align="center">${workTime.workScore }</td>
