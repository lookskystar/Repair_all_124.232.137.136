...
<body>
<form action="uploadExcel!uploadRewardExcel.do" method="post" onsubmit="return subForm();" enctype="multipart/form-data" target="frmright">
	<table class="tableStyle" useHover="false" useClick="false">
	    <tr>
	      <td align="center">
	         <span style="font-weight:bold;font-size:12px;">请选择要导入的Excel文件:</span>
	         <a href="<%=basePath%>kq/reward_temp.xls" style="color: red;">excel模板下载</a>
	      </td>
	    </tr>
		<tr>
