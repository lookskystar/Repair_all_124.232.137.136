...
<body>
<form id="form" action="partFixAction!choiceDyPjInfo.do" method="post">
	<div id="showImage">
  配件编号:<input type="text" style="width: 200px" name="pjNum" value="${pjNum }"/>&nbsp;&nbsp;&nbsp;
	   ...
	   <table width="100%" class="tableStyle" useMultColor="true"  useCheckBox="true">
			<tr>
				...
				<th class="ver01" width="20%" align="center">所属静态配件</th>
	...
	<div class="float_right padding5 paging">
		...
		<pg:pager maxPageItems="${pageSize }" url="partFixAction!choiceDyPjInfo.do" items="${pm.count}" export="page1=pageNumber">
