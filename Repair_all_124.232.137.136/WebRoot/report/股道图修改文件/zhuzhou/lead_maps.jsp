...
<br/>
 <center>
 		<table id="tab" style=" width:70%; height:30px;margin-top:0px; ">	
		    <tr>
			  <td style="font-size: 13px;"><a href="<%=basePath %>report/select_main.jsp" id="megaanchor1">机车检修记录管理</a>
			  &nbsp;&nbsp;&nbsp;<a href="<%=basePath %>pjManage!dyPJListInput.do" target="_blank" >配件检修记录</a>
