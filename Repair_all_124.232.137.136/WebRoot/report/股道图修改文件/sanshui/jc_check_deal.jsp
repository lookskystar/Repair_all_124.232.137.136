	  ...
	  <tr>
		...
		<td>
	    	  ...
	    	  <div id="jgjl">
	    	      ...
	    	      &nbsp;&nbsp;&nbsp;<font size="3">配属&nbsp;广州&nbsp;局&nbsp;三水&nbsp;段_<span id="jctype" style="color: blue"></span>_型号_<span id="jcnum" style="color: blue"></span>_号机车，已于_<span id="kcsj" style="color: blue"></span>_至
	    	      _<span id="jcsj" style="color: blue"></span>_由&nbsp;三水&nbsp;机务段，按照有关技术规定经_<span id="xcxc" style="color: blue"></span>_修次竣工，经局驻段验收员检查验收，确认技术状态合格，准予交付运用。</font>
	    	  </div>
