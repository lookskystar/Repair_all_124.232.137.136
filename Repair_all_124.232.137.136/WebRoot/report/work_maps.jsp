...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		for(var i=0;i<data.length;i++){
			...
			tar.html('<a href="javascript:void(0);" id="'+data[i].jcnum+'" class="jTip" name="<%=basePath %>report!getInfoDetail.do?type=work&rjhmId='+data[i].rjhmId+'">'+data[i].jcnum+'</a>');
		}
...
<!--  
<script type="text/javascript" src="<%=basePath %>report/js/jtip.js"></script>
-->
</head>
