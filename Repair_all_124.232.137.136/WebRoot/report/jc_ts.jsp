...
<ul id="nav">
    ...
    <li><a href="<%=basePath%>query!findJCTS.do?rjhmId=${datePlan.rjhmId}" style="background-color:#fff;color:blue;">◇探伤记录</a></li>
 		      ...
 		      <td class="tbCELL1" align="center" style="word-break:normal;word-wrap: break-word;" width="50%">
 		        <c:if test="${!empty pj.dynamicInfos}">
 		          <c:forEach var="dy" items="${pj.dynamicInfos}">
 		            <a href="query!findPjTS.do?rjhmId=${datePlan.rjhmId}&pjdid=${dy.pjdid}" target="_blank">${dy.pjNum}</a>&nbsp;&nbsp;
 		          </c:forEach>
 		        </c:if>
 		      </td>
 		      </tr>
