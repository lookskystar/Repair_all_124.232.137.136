 ...
 <tr>
	...
	<table width="864" border="0" align="center" cellspacing="0" vspace="0" id="datatabel">
		<tr style="line-height:40px;height: 40px;background-color: lightblue;font-weight: bolder;">
			...
			<td class="tbCELL1" align="center" style="white-space:nowrap" width="12%">探伤情况</td>
			<td class="tbCELL1" align="center" style="white-space:nowrap" width="12%">裂损情况</td>
			<td class="tbCELL1" align="center" style="white-space:nowrap" width="6%">主探</td>
			<td class="tbCELL1" align="center" style="white-space:nowrap" width="6%">复探</td>
		...
		<tr>
			...
			<td class="tbCELL1" align="center">${item.fixsituation}</td>
			<td class="tbCELL1" align="center">${item.dealSituaton}</td>
			...
			<td class="tbCELL1" align="center">
				<c:choose>
					<c:when test="${empty item.rept && item.itemctrlrept==1}"><font color="#FF0000">待签</font></c:when>
					<c:when test="${empty item.rept && item.itemctrlrept!=1}">/</c:when>
					<c:otherwise>${item.rept}<br/>${fn:substring(item.reptAffirmTime,5,fn:length(item.reptAffirmTime)-3)}</c:otherwise>
				</c:choose>
			</td>
			<td class="tbCELL1" align="center">
				<c:choose>
