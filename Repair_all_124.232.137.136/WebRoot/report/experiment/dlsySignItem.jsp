...
<html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <td width="186">
      	 <c:choose>
      	 	<c:when test="${empty experiment.empAffirmTime}">
      	 		<input type="text" id="sytime" class="date" value="${experiment.empAffirmTime}" style="width: 85px;"/>
  ...
  <input type="text" id="rjhmId" value="${datePlan.rjhmId}"/>
  <input type="text" id="expId" value="${expId}"/>
  <input type="text" id="roleFlag" value="${roleFlag}"/>
</div>
</body>
</html>