 ...
 <tr>
	...
	<table width="864" border="0" align="center" cellspacing="0" vspace="0" id="datatabel">
		<tr style="line-height:40px;height: 40px;background-color: lightblue;font-weight: bolder;">
			...
			<td class="tbCELL1" align="center" style="white-space:nowrap" width="50%">配件名称</td>
		</tr>
 		<c:forEach items="${staticInfos}" var="info">
		<tr>
			<td class="tbCELL1" align="center" name="firstname">${info.firstUnit.firstunitname }</td>
			<td class="tbCELL1" align="center" name="secondname"><a href="<%=basePath %>query!zxFittingDetailView.do?id=${datePlan.rjhmId }&staticId=${info.pjsid}" target="_blank">${info.pjName}</a></td>
		</tr>
		</c:forEach>
	</table>
  </td>
