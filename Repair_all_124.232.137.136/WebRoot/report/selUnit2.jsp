...
<body bgcolor="#f8f7f7">
<!-- 浮动导航菜单start -->
<div id="scoll_div_id" style="background:#328aa4;width:960px;height:23px;">
<ul id="nav">
...
<tr><td colspan="6">
<table width="960" border="0" align="center" cellspacing="0" vspace="0" id="content">
 <tr>
	<td align="center" colspan="3" class="tbCELL3">
	<!-- 2015-5-19    黄亮 添加行内样式style="font-size:10pt;"，设置导出Execl字体大小，Execl字体大小必须是行内样式 -->
	<table width="960" border="0" align="center" cellspacing="0" vspace="0" id="datatabel" style="font-size:10pt;">
