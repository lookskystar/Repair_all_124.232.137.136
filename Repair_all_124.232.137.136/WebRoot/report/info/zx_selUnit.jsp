...
<script type="text/javascript">
	...
	$(function(){
         ...
         <c:forEach items="${units}" var="unit" varStatus="index">
         	d.add(${index.index+1},0,'${unit.firstunitname }','<%=basePath%>query!getZxInfoByUnit.do?rjhmId=${rjhmId}&fristUnit=${unit.firstunitid }');
 		</c:forEach>
 ...
 <tr>
	...
	<table width="864" border="0" align="center" cellspacing="0" vspace="0" id="datatabel">
		<tr style="line-height:40px;height: 40px;background-color: lightblue;font-weight: bolder;">
			...
			<td class="tbCELL1" align="center" style="white-space:nowrap" width="10%">所处节点</td>
			<td class="tbCELL1" align="center" style="white-space:nowrap" width="10%">检修情况</td>
			<td class="tbCELL1" align="center" style="white-space:nowrap" width="10%">配件编号</td>
